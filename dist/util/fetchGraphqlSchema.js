...
`;
export default async function fetchGraphQLSchema(endpoint, customIntrospectionQuery) {
    const introspectionQuery = customIntrospectionQuery || DEFAULT_INTROSPECTION_QUERY;
